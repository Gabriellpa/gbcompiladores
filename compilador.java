...
td = token.kind;
  ...
  static final public void Principal() throws ParseException {TokenSymTab.SetTables();
  ...
  static final public void VariaveisLocais() throws ParseException {int td;
        Token var;
    TiposDDados();
td = token.kind;
    var = jj_consume_token(IDENTIFICADOR);
...
TokenSymTab.InserirSimbolo(var, td);
  ...
  static final public void VariaveisAtribuicao(Token v1) throws ParseException {Token v2;
        Token v3;
        String res;
        boolean imp = false;
...
{if ("" != null) return 0;}
  ...
  static final public void TiposDDados() throws ParseException {
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case INTEIRO:{
      jj_consume_token(INTEIRO);
      break;
...
v3 = token;
  ...
  static final public void TiposAtribuicao() throws ParseException {
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case VERDADEIRO:{
